...
export default function Acessibilidade(){
    ...
    return(
        <div>
            ...
            <div className="header-image acessibilidade-tittle">
                <h1>Acessibilid<span className="span-color">ade</span></h1>
            </div>
            <div className="acessibilidade-container">
                ...
                <br></br>
                <br></br>
                <p className="tituloAcessibilidade">Teclas de atalho por navegadores</p>
                <br></br>
                <p className="tituloAcessibilidade">Internet Explorer e Google Chrome:</p>
                <p>“Alt” + “1” - ir para o conteúdo</p>
                <p>“Alt” + “2” - ir para o menu</p>
                <p>“Alt” + “3” - ir para o rodapé</p>
                <br></br>
                <p className="tituloAcessibilidade">Firefox:</p>
                <p>“Alt” + “Shift” + “número”</p>
                <br></br>
                <p className="tituloAcessibilidade">Opera:</p>
                <p>“Shift” + “Escape” + “número”</p>
                <br></br>
                <p className="tituloAcessibilidade">Safari e OmniWeb:</p>
                <p>“Ctrl” + “número”</p>
                <br></br>
                <br></br>
                <p className="tituloAcessibilidade">Navegação por tabulação</p>
                <br></br>
                ...
                <br></br>
                <br></br>
                <p className="tituloAcessibilidade">Sugestões de programas disponíveis para pessoas com deficiência</p>
                <br></br>
                ...
                <br></br>
                <br></br>
                <p className="tituloAcessibilidade">LIBRAS - Língua Brasileira de Sinais</p>
                <br></br>
                <p>Este site é acessível em LIBRAS através do <a href="http://www.vlibras.gov.br/" target="_blank">VLibras</a>.</p>
                <p>-Do lado direito de cada página do site existe o ícone de um Widget informando que o site é acessível em LIBRAS.
                </p>
